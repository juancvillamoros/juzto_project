...
class Video(models.Model):
    ...
    id_audiencia = models.CharField(max_length=255, validators=[RegexValidator(regex='^[a-zA-Z0-9_]*$', message='audiencia invalida')])
    id_comparendo = models.CharField(max_length=255, validators=[RegexValidator(regex='^[a-zA-Z0-9_]*$', message='comparendo invalida')])
    video = models.FileField(upload_to='temp/')
